...
namespace CommonMethod
{
    public class DocumentPrint
    {
        ...
        /// <returns></returns>
        public Point GetScrollPoint(Control MyControl)
        {
        ...
        /// <param name="MyControl"></param>
        public void MoveBar(int Bar, int Point, Control MyControl)
        {
            if (Bar == 0)
            {
        ...
        public void DocPrint(Panel panel1)
        {
            myFormImage = this.GetPanel(panel1);
        ...
        {
            float left = (printDocument1.PrinterSettings.PaperSizes[0].Width - myFormImage.Size.Width) / 2;
            float top = (printDocument1.PrinterSettings.PaperSizes[0].Height - myFormImage.Size.Height) / 2;
            e.Graphics.DrawImage(myFormImage, left, top);
        }
