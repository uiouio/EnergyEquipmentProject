...
{
    public partial class CompanyCarManage_add_Dialog : Form
    {
        ...
        public CompanyCarManage_add_Dialog()
        {
            InitializeComponent();
        }
        ...
        {
            CompanyCustomInfo_add_Dialog1 pad = new CompanyCustomInfo_add_Dialog1();
            pad.IsShowOrInput = 1;
            pad.ShowDialog();
            if (pad.CustomBaseInfo != null)
            {
                commonDataGridView1.Rows.Add(0, 1, pad.CustomBaseInfo.Name, pad.CustomBaseInfo.IdentifyCardNo, pad.CustomBaseInfo.ContactName,pad.CustomBaseInfo.Phone,"查看");
