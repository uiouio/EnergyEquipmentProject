...
{
    public partial class UNDOZiLiaoShenChaCNG : CommonControl.CommonTabPage
    {
        public UNDOZiLiaoShenChaCNG()
        {
            InitializeComponent();
        }
        ...
        */
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 7)
            {
                UNDOZiLiaoShenCha_CNGEdit tt = new UNDOZiLiaoShenCha_CNGEdit();
                tt.ShowDialog();
            }
        }
